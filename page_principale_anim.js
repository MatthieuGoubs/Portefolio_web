document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        'fr': {
            'nav_name': 'Matthieu Goubert - ', 'nav_job': 'Géomaticien & Développeur Web SIG',
            ...
            'about_p3': 'Je conçois des outils interactifs pouvant être pour <strong>le terrain et la mobilité</strong>, garantissant un accès fluide à la donnée complexe, que ce soit sur poste fixe ou smartphone.',
            ...
            'about_history': 'J’ai débuté chez <strong>MENARD Terrassements</strong> sur des études de Défense Extérieure Contre les Incendies, ce qui m’a, par la suite, amené à m’orienter vers le <strong>développement SIG web</strong>. J’ai ensuite approfondi ces domaines en <strong>Master SIGMA</strong> à Toulouse, en alternance au <strong>Conservatoire d\'Espaces Naturels Pays de la Loire</strong>.',
            ...
            'en': {
            'nav_name': 'Matthieu Goubert - ', 'nav_job': 'GIS Specialist & Web Developer ',
            ...
            'about_p3': 'I design interactive tools for <strong>fieldwork and mobile use</strong>, ensuring seamless access to complex data, whether on a desktop computer or a smartphone.',
